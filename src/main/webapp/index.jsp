...
<body>
  ...
  <%
    ...
    {
 %>
  <center><font color="red" size="5">Form submitted succesfully.You will get notified after 24 hrs </font> </center> 
 <%
 }
  %>
    <%
...
%>
 ...
 <input type="mail" name="email" placeholder="Enter Email Address" requireds >
